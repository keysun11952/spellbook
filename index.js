const app = {
  ...
  renderItem: function (spell) {
    ...
    // fav button
    item.querySelector('button.fav').addEventListener('click', this.highlight.bind(this, spell))

    return item
  },

  highlight: function (spell, ev) {
    const button = ev.target
    const item = button.parentNode
    item.querySelector('span').classList.add('fav')
  },
